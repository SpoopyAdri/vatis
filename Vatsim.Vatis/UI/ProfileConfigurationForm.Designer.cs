...
namespace Vatsim.Vatis.UI
{
    partial class ProfileConfigurationForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            Variable variable60 = new Variable();
            Variable variable61 = new Variable();
            Variable variable62 = new Variable();
            Variable variable63 = new Variable();
            ...
            Variable variable64 = new Variable();
            Variable variable65 = new Variable();
            Variable variable66 = new Variable();
            Variable variable67 = new Variable();
            Variable variable68 = new Variable();
            Variable variable69 = new Variable();
            Variable variable70 = new Variable();
            Variable variable71 = new Variable();
            Variable variable72 = new Variable();
            Variable variable73 = new Variable();
            Variable variable74 = new Variable();
            Variable variable75 = new Variable();
            Variable variable76 = new Variable();
            Variable variable77 = new Variable();
            Variable variable78 = new Variable();
            Variable variable79 = new Variable();
            Variable variable80 = new Variable();
            Variable variable81 = new Variable();
            Variable variable82 = new Variable();
            Variable variable83 = new Variable();
            Variable variable84 = new Variable();
            Variable variable85 = new Variable();
            Variable variable86 = new Variable();
            Variable variable87 = new Variable();
            Variable variable88 = new Variable();
            Variable variable89 = new Variable();
            Variable variable90 = new Variable();
            Variable variable91 = new Variable();
            Variable variable92 = new Variable();
            Variable variable93 = new Variable();
            Variable variable94 = new Variable();
            Variable variable95 = new Variable();
            Variable variable96 = new Variable();
            Variable variable97 = new Variable();
            Variable variable98 = new Variable();
            Variable variable99 = new Variable();
            Variable variable100 = new Variable();
            Variable variable101 = new Variable();
            Variable variable102 = new Variable();
            Variable variable103 = new Variable();
            Variable variable104 = new Variable();
            Variable variable105 = new Variable();
            Variable variable106 = new Variable();
            Variable variable107 = new Variable();
            System.Windows.Forms.DataGridViewCellStyle dataGridViewCellStyle13 = new System.Windows.Forms.DataGridViewCellStyle();
            System.Windows.Forms.DataGridViewCellStyle dataGridViewCellStyle14 = new System.Windows.Forms.DataGridViewCellStyle();
            System.Windows.Forms.DataGridViewCellStyle dataGridViewCellStyle15 = new System.Windows.Forms.DataGridViewCellStyle();
            System.Windows.Forms.DataGridViewCellStyle dataGridViewCellStyle16 = new System.Windows.Forms.DataGridViewCellStyle();
            Variable variable108 = new Variable();
            System.Windows.Forms.DataGridViewCellStyle dataGridViewCellStyle17 = new System.Windows.Forms.DataGridViewCellStyle();
            System.Windows.Forms.DataGridViewCellStyle dataGridViewCellStyle18 = new System.Windows.Forms.DataGridViewCellStyle();
            System.Windows.Forms.DataGridViewCellStyle dataGridViewCellStyle19 = new System.Windows.Forms.DataGridViewCellStyle();
            System.Windows.Forms.DataGridViewCellStyle dataGridViewCellStyle20 = new System.Windows.Forms.DataGridViewCellStyle();
            Variable variable109 = new Variable();
            Variable variable110 = new Variable();
            Variable variable111 = new Variable();
            Variable variable112 = new Variable();
            Variable variable113 = new Variable();
            Variable variable114 = new Variable();
            ...
            variable60.Text = "time";
            variable60.ToolTip = "The METAR observation time (e.g. \"0153\").";
            variable61.Text = "hour";
            variable61.ToolTip = "The hour portion of the METAR observation time (e.g \"01\").";
            variable62.Text = "minute";
            variable62.ToolTip = "The minute portion of the METAR observation time (e.g. \"53\").";
            variable63.Text = "special";
            variable63.ToolTip = "Inserts the word \"SPECIAL\" if the METAR observation time is different than the routine observation time.";
            templateObservationTime.Variables.Add(variable60);
            templateObservationTime.Variables.Add(variable61);
            templateObservationTime.Variables.Add(variable62);
            templateObservationTime.Variables.Add(variable63);
            ...
            variable64.Text = "wind";
            variable64.ToolTip = "The complete wind string (e.g. \"25010KT\"). Only available as a text variable.";
            variable65.Text = "wind_dir";
            variable65.ToolTip = "The direction of the wind (e.g. \"25010KT\" would yield \"250\"). Magnetic variation is applied.";
            variable66.Text = "wind_spd";
            variable66.ToolTip = "The speed of the wind (e.g. \"25010KT\" would yield \"10\"). The value can optionally be converted to another unit using \"{wind_spd|kt}\" or \"{wind_spd|mps}\".";
            variable67.Text = "wind_gust";
            variable67.ToolTip = "The gust speed of the wind (e.g. \"25010G15KT\" would yield \"15\"). The value can optionally be converted to another unit using \"{wind_gust|kt}\" or \"{wind_gust|mps}\".";
            variable68.Text = "wind_vmin";
            variable68.ToolTip = "The first extreme wind direction (e.g. \"25015G25KT 250V280\" would yield \"250\"). Magnetic variation is applied.";
            variable69.Text = "wind_vmax";
            variable69.ToolTip = "The last extreme wind direction (e.g. \"25015G25KT 250V280\" would yield \"280\"). Magnetic variation is applied.";
            variable70.Text = "wind_unit";
            variable70.ToolTip = "The wind speed unit of measurement (e.g. \"25010KT\" would yield \"KT\" and the spoken value would be \"knots\"). ";
            templateWindStandard.Variables.Add(variable64);
            templateWindStandard.Variables.Add(variable65);
            templateWindStandard.Variables.Add(variable66);
            templateWindStandard.Variables.Add(variable67);
            templateWindStandard.Variables.Add(variable68);
            templateWindStandard.Variables.Add(variable69);
            templateWindStandard.Variables.Add(variable70);
            ...
            variable71.Text = "wind";
            variable71.ToolTip = "The complete wind string (e.g. \"25010KT\"). Only available as a text variable.";
            variable72.Text = "wind_dir";
            variable72.ToolTip = "The direction of the wind (e.g. \"25010KT\" would yield \"250\"). Magnetic variation is applied.";
            variable73.Text = "wind_spd";
            variable73.ToolTip = "The speed of the wind (e.g. \"25010KT\" would yield \"10\"). The value can optionally be converted to another unit using \"{wind_spd|kt}\" or \"{wind_spd|mps}\".";
            variable74.Text = "wind_gust";
            variable74.ToolTip = "The gust speed of the wind (e.g. \"25010G15KT\" would yield \"15\"). The value can optionally be converted to another unit using \"{wind_gust|kt}\" or \"{wind_gust|mps}\".";
            variable75.Text = "wind_vmin";
            variable75.ToolTip = "The first extreme wind direction (e.g. \"25015G25KT 250V280\" would yield \"250\"). Magnetic variation is applied.";
            variable76.Text = "wind_vmax";
            variable76.ToolTip = "The last extreme wind direction (e.g. \"25015G25KT 250V280\" would yield \"280\"). Magnetic variation is applied.";
            variable77.Text = "wind_unit";
            variable77.ToolTip = "The wind speed unit of measurement (e.g. \"25010KT\" would yield \"KT\" and the spoken value would be \"knots\"). ";
            templateWindStanardGust.Variables.Add(variable71);
            templateWindStanardGust.Variables.Add(variable72);
            templateWindStanardGust.Variables.Add(variable73);
            templateWindStanardGust.Variables.Add(variable74);
            templateWindStanardGust.Variables.Add(variable75);
            templateWindStanardGust.Variables.Add(variable76);
            templateWindStanardGust.Variables.Add(variable77);
            ...
            variable78.Text = "wind";
            variable78.ToolTip = "The complete wind string (e.g. \"25010KT\"). Only available as a text variable.";
            variable79.Text = "wind_dir";
            variable79.ToolTip = "The direction of the wind (e.g. \"25010KT\" would yield \"250\"). Magnetic variation is applied.";
            variable80.Text = "wind_spd";
            variable80.ToolTip = "The speed of the wind (e.g. \"25010KT\" would yield \"10\"). The value can optionally be converted to another unit using \"{wind_spd|kt}\" or \"{wind_spd|mps}\".";
            variable81.Text = "wind_gust";
            variable81.ToolTip = "The gust speed of the wind (e.g. \"25010G15KT\" would yield \"15\"). The value can optionally be converted to another unit using \"{wind_gust|kt}\" or \"{wind_gust|mps}\".";
            variable82.Text = "wind_vmin";
            variable82.ToolTip = "The first extreme wind direction (e.g. \"25015G25KT 250V280\" would yield \"250\"). Magnetic variation is applied.";
            variable83.Text = "wind_vmax";
            variable83.ToolTip = "The last extreme wind direction (e.g. \"25015G25KT 250V280\" would yield \"280\"). Magnetic variation is applied.";
            variable84.Text = "wind_unit";
            variable84.ToolTip = "The wind speed unit of measurement (e.g. \"25010KT\" would yield \"KT\" and the spoken value would be \"knots\"). ";
            templateWindVariable.Variables.Add(variable78);
            templateWindVariable.Variables.Add(variable79);
            templateWindVariable.Variables.Add(variable80);
            templateWindVariable.Variables.Add(variable81);
            templateWindVariable.Variables.Add(variable82);
            templateWindVariable.Variables.Add(variable83);
            templateWindVariable.Variables.Add(variable84);
            ...
            variable85.Text = "wind";
            variable85.ToolTip = "The complete wind string (e.g. \"25010KT\"). Only available as a text variable.";
            variable86.Text = "wind_dir";
            variable86.ToolTip = "The direction of the wind (e.g. \"25010KT\" would yield \"250\"). Magnetic variation is applied.";
            variable87.Text = "wind_spd";
            variable87.ToolTip = "The speed of the wind (e.g. \"25010KT\" would yield \"10\"). The value can optionally be converted to another unit using \"{wind_spd|kt}\" or \"{wind_spd|mps}\".";
            variable88.Text = "wind_gust";
            variable88.ToolTip = "The gust speed of the wind (e.g. \"25010G15KT\" would yield \"15\"). The value can optionally be converted to another unit using \"{wind_gust|kt}\" or \"{wind_gust|mps}\".";
            variable89.Text = "wind_vmin";
            variable89.ToolTip = "The first extreme wind direction (e.g. \"25015G25KT 250V280\" would yield \"250\"). Magnetic variation is applied.";
            variable90.Text = "wind_vmax";
            variable90.ToolTip = "The last extreme wind direction (e.g. \"25015G25KT 250V280\" would yield \"280\"). Magnetic variation is applied.";
            variable91.Text = "wind_unit";
            variable91.ToolTip = "The wind speed unit of measurement (e.g. \"25010KT\" would yield \"KT\" and the spoken value would be \"knots\"). ";
            templateWindVariableGust.Variables.Add(variable85);
            templateWindVariableGust.Variables.Add(variable86);
            templateWindVariableGust.Variables.Add(variable87);
            templateWindVariableGust.Variables.Add(variable88);
            templateWindVariableGust.Variables.Add(variable89);
            templateWindVariableGust.Variables.Add(variable90);
            templateWindVariableGust.Variables.Add(variable91);
            ...
            variable92.Text = "wind";
            variable92.ToolTip = "The complete wind string (e.g. \"25010KT\"). Only available as a text variable.";
            variable93.Text = "wind_dir";
            variable93.ToolTip = "The direction of the wind (e.g. \"25010KT\" would yield \"250\"). Magnetic variation is applied.";
            variable94.Text = "wind_spd";
            variable94.ToolTip = "The speed of the wind (e.g. \"25010KT\" would yield \"10\"). The value can optionally be converted to another unit using \"{wind_spd|kt}\" or \"{wind_spd|mps}\".";
            variable95.Text = "wind_gust";
            variable95.ToolTip = "The gust speed of the wind (e.g. \"25010G15KT\" would yield \"15\"). The value can optionally be converted to another unit using \"{wind_gust|kt}\" or \"{wind_gust|mps}\".";
            variable96.Text = "wind_vmin";
            variable96.ToolTip = "The first extreme wind direction (e.g. \"25015G25KT 250V280\" would yield \"250\"). Magnetic variation is applied.";
            variable97.Text = "wind_vmax";
            variable97.ToolTip = "The last extreme wind direction (e.g. \"25015G25KT 250V280\" would yield \"280\"). Magnetic variation is applied.";
            variable98.Text = "wind_unit";
            variable98.ToolTip = "The wind speed unit of measurement (e.g. \"25010KT\" would yield \"KT\" and the spoken value would be \"knots\"). ";
            templateWindVariableDirection.Variables.Add(variable92);
            templateWindVariableDirection.Variables.Add(variable93);
            templateWindVariableDirection.Variables.Add(variable94);
            templateWindVariableDirection.Variables.Add(variable95);
            templateWindVariableDirection.Variables.Add(variable96);
            templateWindVariableDirection.Variables.Add(variable97);
            templateWindVariableDirection.Variables.Add(variable98);
            ...
            variable99.Text = "wind";
            variable99.ToolTip = "The complete wind string (e.g. \"25010KT\"). Only available as a text variable.";
            variable100.Text = "wind_dir";
            variable100.ToolTip = "The direction of the wind (e.g. \"25010KT\" would yield \"250\"). Magnetic variation is applied.";
            variable101.Text = "wind_spd";
            variable101.ToolTip = "The speed of the wind (e.g. \"25010KT\" would yield \"10\"). The value can optionally be converted to another unit using \"{wind_spd|kt}\" or \"{wind_spd|mps}\".";
            variable102.Text = "wind_gust";
            variable102.ToolTip = "The gust speed of the wind (e.g. \"25010G15KT\" would yield \"15\"). The value can optionally be converted to another unit using \"{wind_gust|kt}\" or \"{wind_gust|mps}\".";
            variable103.Text = "wind_vmin";
            variable103.ToolTip = "The first extreme wind direction (e.g. \"25015G25KT 250V280\" would yield \"250\"). Magnetic variation is applied.";
            variable104.Text = "wind_vmax";
            variable104.ToolTip = "The last extreme wind direction (e.g. \"25015G25KT 250V280\" would yield \"280\"). Magnetic variation is applied.";
            variable105.Text = "wind_unit";
            variable105.ToolTip = "The wind speed unit of measurement (e.g. \"25010KT\" would yield \"KT\" and the spoken value would be \"knots\"). ";
            templateWindCalm.Variables.Add(variable99);
            templateWindCalm.Variables.Add(variable100);
            templateWindCalm.Variables.Add(variable101);
            templateWindCalm.Variables.Add(variable102);
            templateWindCalm.Variables.Add(variable103);
            templateWindCalm.Variables.Add(variable104);
            templateWindCalm.Variables.Add(variable105);
            ...
            variable106.Text = "visibility";
            variable106.ToolTip = "The prevailing visibility (e.g. \"5SM\" or \"5000\")";
            templateVisibility.Variables.Add(variable106);
            ...
            variable107.Text = "weather";
            variable107.ToolTip = "The present weather groups from the METAR report (e.g. \"SHRA BR\")";
            templatePresentWeather.Variables.Add(variable107);
            ...
            // gridWeatherTypes
            // 
            gridWeatherTypes.AllowUserToAddRows = false;
            gridWeatherTypes.AllowUserToDeleteRows = false;
            ...
            gridWeatherTypes.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle13;
            ...
            gridWeatherTypes.DefaultCellStyle = dataGridViewCellStyle14;
            ...
            gridWeatherDescriptors.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle15;
            ...
            gridWeatherDescriptors.DefaultCellStyle = dataGridViewCellStyle16;
            ...
            variable108.Text = "clouds";
            variable108.ToolTip = "The cloud layer groups from the METAR report (e.g. \"SCT150 FEW200\")";
            templateCloudLayers.Variables.Add(variable108);
            ...
            gridCloudTypes.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle17;
            ...
            gridCloudTypes.DefaultCellStyle = dataGridViewCellStyle18;
            ...
            gridConvectiveCloudTypes.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle19;
            ...
            gridConvectiveCloudTypes.DefaultCellStyle = dataGridViewCellStyle20;
            ...
            variable109.Text = "temp";
            variable109.ToolTip = "The temperature value from the METAR (e.g. \"05\")";
            templateTemperature.Variables.Add(variable109);
            ...
            variable110.Text = "dewpoint";
            variable110.ToolTip = "The dewpoint temperature value from the METAR (e.g. \"05\")";
            templateDewpoint.Variables.Add(variable110);
            ...
            variable111.Text = "altimeter";
            variable111.ToolTip = "The altimeter value from the METAR report (e.g. \"2992\" or \"1013\").";
            variable112.Text = "altimeter|text";
            variable112.ToolTip = "Encodes the altimeter value into numeric word form (e.g. \"TWO NINER NINER TWO\")";
            variable113.Text = "altimeter|inhg";
            variable113.ToolTip = "Encodes the altimeter value to inHg (inches mercury) and includes the decimal point (e.g. Text: \"29.92\", Spoken: \"TWO NINER POINT NINER TWO\")";
            variable114.Text = "altimeter|hpa";
            variable114.ToolTip = "Encodes the altimeter value in hPa (hectopascal)";
            templateAltimeter.Variables.Add(variable111);
            templateAltimeter.Variables.Add(variable112);
            templateAltimeter.Variables.Add(variable113);
            templateAltimeter.Variables.Add(variable114);
            ...
            variable115.Text = "trl";
            variable115.ToolTip = "The transition level altitude value (e.g. \"65\")";
            variable116.Text = "trl|text";
            variable116.ToolTip = "Encodes the transition level altitude value into numeric word form (e.g. \"SIX FIVE\")";
            templateTransitionLevel.Variables.Add(variable115);
            templateTransitionLevel.Variables.Add(variable116);
            ...
            gridTransitionLevels.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle21;
            ...
            gridTransitionLevels.DefaultCellStyle = dataGridViewCellStyle22;
            ...
            variable117.Text = "letter";
            variable117.ToolTip = "The current ATIS letter (e.g. \"A\")";
            variable118.Text = "letter|word";
            variable118.ToolTip = "The current ATIS letter in word form (e.g. \"ALPHA\")";
            templateClosingStatement.Variables.Add(variable117);
            templateClosingStatement.Variables.Add(variable118);
            ...
            gridContractions.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle23;
            ...
            gridContractions.DefaultCellStyle = dataGridViewCellStyle24;
